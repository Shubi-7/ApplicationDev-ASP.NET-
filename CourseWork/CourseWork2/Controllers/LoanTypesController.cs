...
namespace CourseWork2.Controllers
{
    public class LoanTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,Days")] LoanType loanType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,Days")] LoanType loanType)
        {
            if (ModelState.IsValid)
            {
